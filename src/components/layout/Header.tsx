                    ...
                    <div className="w-[340px] bg-[#0D1727] border border-white/[0.08] rounded-2xl p-2 shadow-2xl shadow-black/60">
                      {servicesData.map((s) => (
                        <Link
                          ...
                          className="flex items-start justify-between gap-4 p-3 rounded-xl hover:bg-white/[0.05] transition-colors group/item"
                        >
                          ...
                          <ArrowRight className="w-4 h-4 text-slate-500 opacity-0 -translate-x-1 group-hover/item:translate-x-0 group-hover/item:opacity-100 group-hover/item:text-emerald-400 transition-all shrink-0 mt-0.5" />
                        </Link>
                      ))}
                    </div>
                  </div>
