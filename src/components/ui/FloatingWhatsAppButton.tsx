...
export default function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 sm:bottom-6 sm:right-6 animate-fadeIn"
    >
      ...
      <span className="relative flex items-center justify-center w-14 h-14 sm:w-12 sm:h-12 rounded-full bg-[#25D366] text-white shadow-xl shadow-emerald-950/60 border border-white/20 whatsapp-float hover:scale-105 active:scale-[0.98] transition-transform">
