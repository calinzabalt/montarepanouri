...
export default function BlogSection({
  ...
  subtitle = "Află sfaturi practice despre alegerea bateriilor, dosarul de prosumator, curățarea panourilor și noutățile din piața de energie.",
  limit,
}: BlogSectionProps) {
            ...
            <div className="lg:col-span-6 p-8 sm:p-10 flex flex-col justify-between space-y-6">
              ...
              <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl shadow-md transition-all"
                >
